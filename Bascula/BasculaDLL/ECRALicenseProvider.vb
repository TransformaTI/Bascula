...
Public Class ECRALicenseProvider
    ...
    Public Overrides Function GetLicense(ByVal context As LicenseContext, ByVal typ As System.Type, ByVal instance As Object, _
                                         ByVal allowExceotionas As Boolean) As License
